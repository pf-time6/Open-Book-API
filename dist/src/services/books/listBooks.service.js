...
const listBooksService = () => __awaiter(void 0, void 0, void 0, function* () {
    const booksRepo = data_source_1.default.getRepository(books_entity_1.default);
    const books = yield booksRepo.find({
        relations: {
            author: true,
        },
    });
    const booksResponse = yield books_1.listBooksResponseSchema.validate(books, {
        stripUnknown: true,
    });
    return booksResponse;
});
exports.default = listBooksService;
//# sourceMappingURL=listBooks.service.js.map